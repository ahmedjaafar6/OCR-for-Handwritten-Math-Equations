...
class DCCNN(nn.Module):
    def __init__(self):
        ...
        conv11 = nn.Conv2d(1, 64, 7, padding='same')
        conv12 = nn.Conv2d(1, 64, 7, padding='same')
        conv21 = nn.Conv2d(128, 128, 5, padding='same') 
        conv22 = nn.Conv2d(128, 128, 5, padding='same')
        conv31 = nn.Conv2d(256, 256, 5, padding='same')
        conv32 = nn.Conv2d(256, 256, 5, padding='same')
        conv33 = nn.Conv2d(256, 256, 5, padding='same')
        conv34 = nn.Conv2d(256, 256, 5, padding='same')
        conv35 = nn.Conv2d(256, 256, 5, padding='same')
        conv36 = nn.Conv2d(256, 256, 5, padding='same')
