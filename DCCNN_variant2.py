...
class DCCNN(nn.Module):
    def __init__(self):
        ...
        conv23 = nn.Conv2d(128, 128, 3, padding='same')
        conv24 = nn.Conv2d(128, 128, 3, padding='same')

        conv31 = nn.Conv2d(512, 512, 3, padding='same')
        conv32 = nn.Conv2d(512, 512, 3, padding='same')
        ...
        self.dense = nn.Sequential(nn.Linear(16384, get_key_length())) #1536
